...
export function TrainingAnalysisWorkspace({ analysis, view, routineId, muscleKey, exerciseQuery, exerciseRoutineId, exerciseMuscleKey }: { analysis: TrainingAnalysis; view: TrainingAnalysisView; routineId: string | null; muscleKey: string | null; exerciseQuery?: string; exerciseRoutineId?: string | "all"; exerciseMuscleKey?: string | "all" }) {
  const state: WorkspaceState = { view, period: analysis.period, routineId, muscleKey, exerciseQuery, exerciseRoutineId, exerciseMuscleKey };
